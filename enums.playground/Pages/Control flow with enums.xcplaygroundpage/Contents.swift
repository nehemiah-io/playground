...
func getWeekdayName(day: Weekday) -> String{
    ...
    case .wednsday: dayOfTheWeek = "Wednsday"
...
return "The day of the week is \(dayOfTheWeek)"
}

print(getWeekdayName(day: .tuesday))


func isItFinallyWeekend(day: Weekday) -> String{
    let isItWeekend: String
    switch day{
    case .saturday: return "Wuhuuu it's SATRUDAYYYY"
    case .sunday: return "At least it's not Monday amirite?!"
    case .monday: return "I hate Monday and it should go away."
    default: return "regular workday"
    }
}

print(isItFinallyWeekend(day: .monday))
